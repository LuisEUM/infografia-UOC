...
import { CONTINENT_COLORS, CYAN_COLOR_SCALE } from "./colorUtils";
      ...
      <div className='mb-8'>
        ...
        <div className='flex items-center mb-4'>
          ...
          <h1 className='text-3xl font-bold'>
            Documentación de Colores y Tema
          </h1>
        </div>
        <p className='text-gray-600 mb-8'>
          Esta página documenta el sistema completo de colores utilizado en la
        ...
        <>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8'>
            <div className='bg-white rounded-lg shadow p-6'>
              ...
              <p className='mb-4 text-gray-600'>
                En el modo "Un Color", se utiliza una escala de colores cyan que
                ...
                <div className='space-y-4'>
                  <div className='border-l-4 border-blue-500 pl-4'>
                    <h3 className='font-semibold text-blue-700'>
                      Varios Colores (Recomendado para)
                    </h3>
